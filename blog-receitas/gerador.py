...
SLUGS_TRADUZIDOS = {
    'exercicios-para-a-terceira-idade': {
        'pt': 'exercicios-para-a-terceira-idade',
        'en': 'exercises-for-seniors',
        'es': 'ejercicios-para-la-tercera-edad'
    },
    'como-o-sono-afeta-a-longevidade': {
        'pt': 'como-o-sono-afeta-a-longevidade',
        'en': 'how-sleep-affects-longevity',
        'es': 'como-el-sueno-afecta-la-longevidad'
    },
    'como-criar-uma-rotina-matinal-saudavel': {
        'pt': 'como-criar-uma-rotina-matinal-saudavel',
        'en': 'how-to-create-a-healthy-morning-routine',
        'es': 'como-crear-una-rutina-matutina-saludable'
    },
    '10-alimentos-ricos-em-fibras-para-melhorar-o-intestino': {
        'pt': '10-alimentos-ricos-em-fibras-para-melhorar-o-intestino',
        'en': '10-fiber-rich-foods-to-improve-gut-health',
        'es': '10-alimentos-ricos-en-fibra-para-mejorar-el-intestino'
    },
    'o-que-comer-antes-e-depois-do-treino': {
        'pt': 'o-que-comer-antes-e-depois-do-treino',
        'en': 'what-to-eat-before-and-after-workout',
        'es': 'que-comer-antes-y-despues-del-entreno'
    },
    'como-dormir-melhor-naturalmente': {
        'pt': 'como-dormir-melhor-naturalmente',
        'en': 'how-to-sleep-better-naturally',
        'es': 'como-dormir-mejor-naturalmente'
    }
}
...
class Gerador:
    ...
    def get_frase_hero_traduzida(self, idioma):
        """Retorna a frase do hero traduzida"""
    ...
    def get_slogan_traduzido(self, idioma):
        """Retorna o slogan traduzido"""
        return TRADUCAO_CONFIG.get(idioma, {}).get('slogan', self.config.get('slogan', ''))
    
    def formatar_titulo_categoria(self, slug):
        """Formata o nome da categoria a partir do slug"""
        # Primeiro tenta buscar o nome traduzido
...
"""
    ...
    def gerar_descricao_categoria(self, categoria, idioma=None):
        ...
        descricoes = {
            ...
            'en': {
                ...
                'saude': 'Content on preventive health, wellness and quality of life.'
            },
            'es': {
                ...
                'saude': 'Contenidos sobre salud preventiva, bienestar y calidad de vida.'
            }
        }
    ...
    def gerar_conteudo_ia(self, artigo, link, categoria="geral", palavras_chave="", tipo="review", idioma="pt", links_internos="", links_externos=""):
        ...
        if prompt_template:
            ...
            prompt = prompt.replace('{idioma}', nome_idioma)
    ...
    def _gerar_prompt_fallback(self, artigo, link, categoria, palavras_chave, tipo="review", idioma="pt"):
        ...
        tipos = {
            ...
            """,
            'lista': f"""
            Crie uma LISTA com {artigo} em {nome_idioma}.
            NICHO: {titulo_categoria}
            TOM: {prompt_nicho['tom']}
            PALAVRAS-CHAVE: {palavras_chave or prompt_nicho['palavras']}
            ESTRUTURA: Título, Introdução, 8-12 itens, FAQ (com <details> e <summary>), Conclusão
            Use classes: article-table, faq, faq-item
            O conteúdo deve ser 100% em {nome_idioma}.
            Retorne APENAS HTML válido.
            """,
            'tutorial': f"""
            Crie um TUTORIAL sobre {artigo} em {nome_idioma}.
            NICHO: {titulo_categoria}
            TOM: {prompt_nicho['tom']}
            PALAVRAS-CHAVE: {palavras_chave or prompt_nicho['palavras']}
            ESTRUTURA: Título, Introdução, Materiais, Passo a passo, FAQ (com <details> e <summary>), Conclusão
            Use classes: article-table, faq, faq-item
            O conteúdo deve ser 100% em {nome_idioma}.
            Retorne APENAS HTML válido.
            """
    ...
    def _gerar_faq_fallback(self, categoria, idioma="pt"):
        ...
        }.get(idioma, 'Perguntas Frequentes')
        ...
        respostas = {
            'pt': {
                ...
                'Qual a importância da alimentação?': 'A alimentação é um dos pilares mais importantes para a longevidade e qualidade de vida.',
                'Exercícios físicos ajudam?': 'Sim! A prática regular de exercícios aumenta a expectativa de vida e melhora a saúde geral.',
                'Como manter a mente saudável?': 'Mantenha-se mentalmente ativo com leitura, aprendizado contínuo e conexões sociais.'
            },
            'en': {
                'Qual o tempo de preparo?': 'The average preparation time is 30 to 45 minutes, depending on the recipe.',
                ...
                'Serve para quantas pessoas?': 'Most recipes serve 2 to 4 people, but you can adjust the quantities.',
                'Como armazenar as sobras?': 'Store in a sealed container in the refrigerator for up to 3 days.',
                ...
                'Preciso de algum equipamento?': 'Most practices only require a comfortable space and appropriate clothing.',
                ...
                'Qual a importância da alimentação?': 'Nutrition is one of the most important pillars for longevity and quality of life.',
                'Exercícios físicos ajudam?': 'Yes! Regular exercise increases life expectancy and improves overall health.',
                'Como manter a mente saudável?': 'Stay mentally active with reading, continuous learning and social connections.'
            },
            'es': {
                'Qual o tempo de preparo?': 'El tiempo medio de preparación es de 30 a 45 minutos, dependiendo de la receta.',
                ...
                'Serve para quantas pessoas?': 'La mayoría de las recetas sirven de 2 a 4 personas, pero puedes ajustar las cantidades.',
                'Como armazenar as sobras?': 'Guarda en un recipiente cerrado en el refrigerador hasta por 3 días.',
                ...
                'Preciso de algum equipamento?': 'La mayoría de las prácticas solo requieren un espacio cómodo y ropa adecuada.',
                ...
                'Qual a importância da alimentação?': 'La alimentación es uno de los pilares más importantes para la longevidad y calidad de vida.',
                'Exercícios físicos ajudam?': '¡Sí! El ejercicio regular aumenta la esperanza de vida y mejora la salud general.',
                'Como manter a mente saudável?': 'Mantente mentalmente activo con lectura, aprendizaje continuo y conexiones sociales.'
            }
        }
    ...
    def conteudo_basico(self, artigo, link, tipo="review", idioma="pt"):
        ...
        textos = {
            'pt': {
                ...
                'comprar': 'Comprar Agora',
                'ver_oferta': 'Ver Oferta',
                'jornada': 'Comece sua jornada de saúde e bem-estar agora'
            },
            'en': {
                'review': f"Complete Review: {artigo}",
                'guia': f"Complete Guide: {artigo}",
                'lista': f"List: {artigo}",
                'tutorial': f"Tutorial: {artigo}",
                ...
                'comprar': 'Buy Now',
                'ver_oferta': 'View Offer',
                'jornada': 'Start your health and wellness journey now'
            },
            'es': {
                'review': f"Review Completo: {artigo}",
                'guia': f"Guía Completa: {artigo}",
                'lista': f"Lista: {artigo}",
                'tutorial': f"Tutorial: {artigo}",
                'comparativo': f"Comparativo: {artigo}",
                ...
                'comprar': 'Comprar Ahora',
                'ver_oferta': 'Ver Oferta',
                'jornada': 'Comienza tu viaje de salud y bienestar ahora'
            }
        }
...
"""
    ...
    def get_nome_categoria_traduzido(self, categoria, idioma):
        """Retorna o nome EXIBIDO da categoria no idioma (para menu, footer, badges)"""
...
<header>
    ...
    def get_head(self, titulo, descricao, url, imagem="", extra="", idioma="pt", slug="", eh_artigo=False, categoria_original=None):
        """
        Gera o HEAD da página.
        
        PARÂMETROS:
        - eh_artigo: Se True, gera hreflang. Se False (index, categoria, etc), NÃO gera hreflang.
        - categoria_original: Categoria em PT para usar nos hreflangs (ex: 'longevidade')
        - slug: O slug do artigo no idioma atual (ex: 'how-sleep-affects-longevity' para EN)
        """
        ...
        # Nome do site traduzido
        site_name = self.get_nome_site_traduzido(idioma)
        
        hreflang_tags = ""
        base_url = self.config.get('url_base', '')
        
        # SÓ GERA HREFLANG SE FOR ARTIGO
        if eh_artigo:
            # Usa a categoria original passada ou detecta da URL
            ...
            # ===== CORREÇÃO: USA O MAPA DE SLUGS =====
            # Tenta encontrar o slug no mapa
            slug_pt = slug
            slug_en = slug
            slug_es = slug
            
            # Procura no mapa de slugs
            for key in SLUGS_TRADUZIDOS:
                if slug == key or slug == SLUGS_TRADUZIDOS[key]['pt'] or slug == SLUGS_TRADUZIDOS[key]['en'] or slug == SLUGS_TRADUZIDOS[key]['es']:
                    slug_pt = SLUGS_TRADUZIDOS[key]['pt']
                    slug_en = SLUGS_TRADUZIDOS[key]['en']
                    slug_es = SLUGS_TRADUZIDOS[key]['es']
                    break
            
            # Fallback: se não encontrou, tenta traduzir
            if slug_pt == slug and slug_en == slug and slug_es == slug:
                if idioma == 'pt':
                    slug_pt = slug
                else:
            ...
            # x-default sempre aponta para PT
            cat_pt_traduzida = self.get_categoria_traduzida(cat_pt, 'pt')
            url_default = f"{base_url}/pt/{cat_pt_traduzida}/{slugs['pt']}/"
  ...
  <div class="post-card-body">
    ...
    <a href="/{idioma}/{categoria_traduzida}/{a['slug']}/" class="read-more">Ler mais →</a>
        ...
        head_html = self.get_head(
            ...
            idioma=idioma,
            eh_artigo=False  # CATEGORIA NÃO TEM HREFLANG
        )
        ...
        if template_html:
            variaveis = {
                ...
                'HEAD': self.get_head(
                    ...
                    idioma=idioma,
                    eh_artigo=False  # INDEX NÃO TEM HREFLANG
                ),
...
<body>
    ...
    def criar_artigo(self, artigo_data, forcar=False, revisar=True, idioma=None, forcar_head=False, nova_imagem=False):
        ...
        # TRADUZ O TÍTULO E A DESCRIÇÃO PARA O IDIOMA
        if idioma != 'pt':
  ...
  <div class="post-card-body">
    ...
    <a href="/{idioma}/{cat_traduzida_rel}/{a['slug']}/" class="read-more">Ler mais →</a>
            ...
            head_html = self.get_head(titulo, descricao_traduzida, url, imagem, idioma=idioma, slug=slug, eh_artigo=True, categoria_original=categoria)
            variaveis = {
                'HEAD': head_html,
                'TITULO': titulo,
...
<body>
    ...
    def _atualizar_head_artigo(self, caminho, artigo_data, idioma, slug):
        try:
            ...
            novo_head = self.get_head(titulo, descricao_traduzida, url, imagem, idioma=idioma, slug=slug, eh_artigo=True, categoria_original=categoria)
    ...
    def traduzir_titulo(self, titulo, idioma_destino):
        mapa_titulos = {
            'en': {
                ...
                'Como Dormir Melhor Naturalmente': 'How to Sleep Better Naturally'
            },
            'es': {
                ...
                'Como Dormir Melhor Naturalmente': 'Cómo Dormir Mejor Naturalmente'
            }
        }
    ...
    def publicar_com_traducao(self):
        ...
        for i, a in enumerate(publicados_pt, 1):
            ...
            categoria = self.get_nome_categoria_traduzido(a.get('categoria', 'geral'), 'pt')
            
            titulo_en = self.traduzir_titulo(titulo, 'en') or titulo
            existe_en = titulo_en in titulos_en
            
            titulo_es = self.traduzir_titulo(titulo, 'es') or titulo
        ...
        for idioma in ['en', 'es']:
            ...
            titulo_traduzido = self.traduzir_titulo(titulo_pt, idioma) or titulo_pt
            ...
            artigo_traduzido = {
                ...
                'links_internos': artigo_pt.get('links_internos', ''),
                'links_externos': artigo_pt.get('links_externos', '')
            }
    ...
    def ver_artigos(self):
        ...
        if rascunhos:
            ...
            for a in rascunhos:
                ...
                categoria = self.get_nome_categoria_traduzido(a.get('categoria', 'geral'), idioma)
                print(f"  [{idx}] ⏳ {nome:<40} {categoria}")
                idx += 1
            ...
            for a in publicados:
                ...
                if data:
                    try:
                        ...
                        pass
                print(f"  [{idx}] ✅ {nome:<40} {categoria:<12} {data}")
                idx += 1
        
        print("\n" + "-" * 70)
        escolha = self.ler_numero("Escolha o número do artigo (0 para voltar): ", 0, len(artigos))
        if escolha is None or escolha == 0:
            return
        
        # Pega o artigo escolhido
        ...
        while True:
            ...
            if is_publicado:
                data = artigo_escolhido.get('data_publicacao', '')
                if data:
                    try:
                        data = datetime.strptime(data, "%Y-%m-%d").strftime("%d/%m/%Y")
                    except:
                ...
                print("  2. 🔄 Regenerar CONTEÚDO com IA")
                print("  3. 🖼️ Regenerar IMAGEM")
                print("  4. ❌ Voltar")
            ...
            if opcao == "1":
                if is_publicado:
                    # Ver no navegador
                    slug = self.criar_slug(artigo_escolhido.get('artigo', ''))
                    ...
                    print(f"   🗺️ Sitemap atualizado!")
                    input("\nPressione Enter...")
                    return
            elif opcao == "2":
                if is_publicado:
                    # Regenerar imagem (publicado)
                    print(f"\n🖼️ Regenerando imagem: {nome}")
                    self.criar_artigo(artigo_escolhido, forcar=False, revisar=False, idioma=idioma, nova_imagem=True)
                    print(f"   ✅ Imagem regenerada com sucesso!")
                    input("\nPressione Enter...")
                else:
                    # Regenerar conteúdo (rascunho)
                    print(f"\n🔄 Regenerando conteúdo: {nome}")
                    self.criar_artigo(artigo_escolhido, forcar=True, revisar=True, idioma=idioma, forcar_head=False)
                    print(f"   ✅ Conteúdo regenerado com sucesso!")
                    input("\nPressione Enter...")
            elif opcao == "3":
                if is_publicado:
                    # Despublicar
                    ...
                    print(f"   🗺️ Sitemap atualizado! (artigo removido)")
                    input("\nPressione Enter...")
                    return
                else:
                    # Regenerar imagem (rascunho)
                    print(f"\n🖼️ Regenerando imagem: {nome}")
                    self.criar_artigo(artigo_escolhido, forcar=False, revisar=False, idioma=idioma, nova_imagem=True)
                    print(f"   ✅ Imagem regenerada com sucesso!")
                    input("\nPressione Enter...")
